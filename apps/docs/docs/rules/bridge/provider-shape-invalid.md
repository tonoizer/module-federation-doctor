...
Pass a complete options object (loader/module plus fallback/loading, or a root component for export-app). Turn the rule `"off"` when source facts are too thin or the call shape is dynamic.
