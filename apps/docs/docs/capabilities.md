...
| Capability                             | Vite / Rolldown / Vite Plus                                     | Rspack                | Rsbuild               | Webpack               | Modern.js                                                | Nuxt 3/4 (**partial**)                                        |
| -------------------------------------- | --------------------------------------------------------------- | --------------------- | --------------------- | --------------------- | -------------------------------------------------------- | ------------------------------------------------------------- |
| Explicit MF config                     | Yes                                                             | Yes                   | Yes                   | Yes                   | Yes                                                      | Yes                                                           |
| Static imports                         | Yes                                                             | Yes                   | Yes                   | Yes                   | Yes                                                      | Yes                                                           |
| Supported dynamic patterns (see below) | Yes                                                             | Yes                   | Yes                   | Yes                   | Yes                                                      | Yes                                                           |
| Manifest and stats                     | Opt-in (`manifest: true`); no webpack stats                     | Default (`!== false`) | Default (`!== false`) | Default (`!== false`) | Default under hood; see [matrix](./runtime-manifests.md) | Adapter defaults `manifest: true`; no webpack stats           |
