...
const demoByRule = {
  ...
  "artifact/react-dom-server-in-web": "showcase",
  ...
  "bridge/export-app-missing": "showcase",
  ...
  "config/js-remote-without-type-urls": "showcase",
  ...
  "vite/remotes-prefer-module": "showcase",
  ...
  "vite/hashed-remote-filename": "showcase",
  "vite/remote-hmr-dev": "unit",
  "vite/alias-share-bypass": "showcase",
  "vite/server-origin": "unit",
  "vite/virtual-module-dir": "unit",
  "vite/ignore-origin": "unit",
  ...
  "runtime-plugins/create-script-cors-parity": "showcase",
  "runtime-plugins/create-script-without-link": "unit",
  "runtime-plugins/invalid-factory": "showcase",
...
const plans: Record<string, RulePlan> = {
  ...
  "config/nested-producer-dts-extract": plan(
    ...
    "project",
    "high",
    "Declared exposes, remotes, and dts.generateTypes.extractRemoteTypes are exact for this shape check.",
  ),
  "config/js-remote-without-type-urls": plan(
    1,
    "warning",
    "config.declared",
    "declared",
  ...
  "vite/virtual-module-dir": plan(
    ...
    "project",
    "high",
    "Declared virtualModuleDir is exact; slashes fail, a simple name passes, absence skips.",
    VITE,
  ),
  "vite/ignore-origin": plan(
    6,
    "info",
    "config.declared",
    "declared",
    "project",
    "high",
    "Absent plugin server.origin fact → unknown; ignoreOrigin false or observed origin → pass.",
    VITE,
  ),
...
const evidenceReadsByRule: Record<string, readonly string[]> = {
  ...
  "config/js-remote-without-type-urls": ["project.scope", "moduleFederation"],
  ...
  "vite/virtual-module-dir": ["project.scope", "moduleFederation", "bundler.name"],
  "vite/ignore-origin": ["project.scope", "moduleFederation", "bundler.name", "bundler.viteConfig"],
  "config/transform-import-share-conflict": [
    "project.scope",
    "moduleFederation",
...
function requirementFor(id: string, spec: RulePlan): EvidenceRequirement {
  ...
  const optionalPluginFacts: Record<string, readonly string[]> = {
    ...
    "vite/ignore-origin": ["bundler.viteConfig"],
