...
const headingTranslations = new Map([
  ...
  ["## `doctor/partial-analysis` is not green", "## `doctor/partial-analysis` ist kein Grün"],
  ["## Who this helps", "## Wen das unterstützt"],
  ["## Out of scope (do not invent)", "## Außerhalb des Umfangs (nicht erfinden)"],
